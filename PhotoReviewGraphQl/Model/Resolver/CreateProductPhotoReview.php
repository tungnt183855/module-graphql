 ...
 */
class CreateProductPhotoReview implements ResolverInterface
{
    /**
     * @var ReviewHelper
     */
    ...
    public function resolve(
        ...
        $dataPhotoReview = [
            ...
            'photo_review_is_recommend' => $input['photo_review_is_recommend'],
            'photo_review_pros' => $input['photo_review_pros'],
            'photo_review_cons' => $input['photo_review_cons'],
            'photo_external_links' => $input['photo_external_links'],
            'photo' => $input['photo'],
        ];

        return ['review' => array_merge($this->reviewDataMapper->map($review), $dataPhotoReview)];
    }
}
